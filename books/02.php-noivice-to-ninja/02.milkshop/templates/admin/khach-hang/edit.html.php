<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <h1 class="h2 my-5 text-center">Cập nhật tài khoản</h1>

    <div class="row justify-content-center">
        <div class="col-md-8 col-xl-7">
            <form action="" method="POST">
                <input type="hidden" name="khach-hang[id]" value="<?= $khach_hang->id ?>">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Tên" name="khach-hang[ten]"
                           autocomplete="off" value="<?= $khach_hang->ten ?>" required>
                </div>
                <div class="mb-3">
                    <label for="select3" class="form-label">Giới tính</label>
                    <select class="form-select" id="select3" name="khach-hang[gioi_tinh]" required>
                        <option value="Nam" <?= $khach_hang->gioi_tinh === 'Nam' ? 'selected' : '' ?>>Nam</option>
                        <option value="Nữ" <?= $khach_hang->gioi_tinh === 'Nữ' ? 'selected' : '' ?>>Nữ</option>
                    </select>
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlTextarea2" class="form-label">Địa chỉ</label>
                    <textarea class="form-control" id="exampleFormControlTextarea2" rows="3" name="khach-hang[dia_chi]"><?= $khach_hang->dia_chi ?></textarea>
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput2" placeholder="Số điện thoại"
                           name="khach-hang[dien_thoai]" autocomplete="off" value="<?= $khach_hang->dien_thoai ?>" required>
                </div>
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="exampleFormControlInput" placeholder="Email"
                           name="khach-hang[email]" autocomplete="off" value="<?= $khach_hang->email ?>" required>
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput3" placeholder="Tên đăng nhập"
                           name="khach-hang[ten_dang_nhap]" autocomplete="off" value="<?= $khach_hang->ten_dang_nhap ?>" required>
                </div>
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="exampleFormControlInput3" placeholder="Mật khẩu"
                           name="khach-hang[mat_khau]" autocomplete="off" value="<?= $khach_hang->mat_khau ?>" required>
                </div>
                <div class="mb-3">
                    <label for="select4" class="form-label">Loại tài khoản</label>
                    <select class="form-select" id="select4" name="khach-hang[kieu]" required>
                        <option value="user" <?= $khach_hang->kieu === 'user' ? 'selected' : '' ?>>Người dùng bình thường</option>
                        <option value="admin" <?= $khach_hang->kieu === 'admin' ? 'selected' : '' ?>>Quản trị viên</option>
                    </select>
                </div>
