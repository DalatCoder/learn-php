        ...
        <div class="col-md-8 col-xl-7">
            <form action="" method="POST">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Tên loại sữa"
                           name="loai-sua[ten_loai]" autocomplete="off" required>
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">Mô tả</label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="loai-sua[mo_ta]"></textarea>
                </div>
                <div class="mb-3">
